...
export default function Home() {
  ...
  const contractAddress = "0x98f11F3b779Ba4273723E3Afc661D73c2552a6AE";
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Buy Ratish a Coffee!</title>
      ...
      <footer className={styles.footer}>
        ...
        >
          Created by @ImperorEth for Alchemy's Road to Web3 lesson two!
        </a>
      </footer>
    </div>
  )
